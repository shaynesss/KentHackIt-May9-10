...
│   ├── src/App.jsx                  ← full frontend (single file)
│   ├── public/logo.png              ← app logo
│   └── dist/                        ← production build (served by FastAPI)
├── static/                          ← generated audio files
├── venv/                            ← virtual environment
├── app.py                           ← FastAPI backend
├── grader.py                        ← CV grading agent
├── roaster.py                       ← CV roasting agent
├── pipeline.py                      ← connects grader and roaster
├── voice.py                         ← ElevenLabs audio generation
